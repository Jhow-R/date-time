...
namespace Secao7
{
    class Program
    {
        ...
        private static void RepresentandoDataHora()
        {
            ...
            DateTime d10 = DateTime.ParseExact("2000-08-15", "yyyy-MM-dd", System.Globalization.CultureInfo.InvariantCulture);
            Console.WriteLine(d10);

            DateTime d11 = DateTime.ParseExact("15/08/2000 13:05:58", "dd/MM/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture);
        ...
        private static void CultureInfo()
        {
